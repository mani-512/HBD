...
function menuju(){
  // Navigate directly to the surprise page without showing the success dialog
...
function aktipesan2(){
  ...
  new TypeIt("#kalimat", {
    ...
    startDelay: 60,
    // increase speed value (ms per char) to make typing visibly slower
    speed: 80,
    cursor: true,
    // slower delete speed for smoother pacing
    deleteSpeed: 60,
    breakLines: false,
    waitUntilVisible: true,
    lifelike: true,
    afterComplete: function(){
      ...
      // give a slightly longer pause before continuing
      setTimeout(aktipesan4, 1200);
    },
  }).go();
}
